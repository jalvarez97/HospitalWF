    ...
    internal class Automatizacion
    {
        ...
        public List<Medico> GenerarMedicos(int generar)
        {
            ...
            for (int i = 0; i < generar; i++)
            {
                ...
                if (nDecididor % 2 == 0)
                {
                    oPersona = new Persona(lstNombrOcupacionsHombre[nNombreMedico], rnd.Next(18, 45), true
                ...
                {
                    oPersona = new Persona(lstNombrOcupacionsMujer[nNombreMedico], rnd.Next(18, 45), false
